    ...
    <div class="container"> 
      ...
      <ul class="nav nav-collapse pull-right">
        <?php if(!empty($_SESSION['nom'])){ ?>
          ...
          <li class="<?php if ($first_part==" Se déconnecter") {echo "active"; }?>"><a href="resume.html"><i class="icon-power-off"></i>  Se déconnecter</a></li>
        <?php } else { ?>
          <li class="<?php if ($first_part==" Se connecter") {echo "active"; }?>"><a href="resume.html"><i class="icon-power-off"></i> Se connecter</a></li>
        <?php } ?>
          <li class="<?php if ($first_part==" Contactez-nous") {echo "active"; }?>"><a href="contact.html"><i class="icon-mail"></i> Contactez-nous</a></li>
      </ul>
