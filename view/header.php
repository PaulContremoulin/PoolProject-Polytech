...
<nav id="sidebar-wrapper">
    <ul class="sidebar-nav">
        ...
        <li><a href="index.php?controller=admin&amp;action=resultats"><i class="icon-user"></i> Resultats Promo/Departement</a></li>
        ...
        <li><a href="index.php?controller=admin&amp;action=listadmins"><i class="icon-doc-text"></i>Gestion Administrateur</a></li><li><a href="index.php?controller=admin&amp;action=listpromo><i class="icon-doc-text"></i>Gestion Promo</a></li>
